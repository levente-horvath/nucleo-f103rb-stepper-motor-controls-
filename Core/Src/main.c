...
void delay_us (uint16_t us) // delay in picoseconds
  {
  	__HAL_TIM_SET_COUNTER(&htim1,0);
  	while (__HAL_TIM_GET_COUNTER(&htim1) < us);
}

void stepper_set_rpm (int rpm)  // max RPM 13
{
...
void stepper_move(int direction, int degree, int rpm){


	int real_degree = 1.4222222222222223 * degree;
...
int main(void)
{
  ...
  while (1)
  {
	 stepper_move(0, 180, 13);

	 stepper_move(1, 90, 13);
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, GPIO_PIN_1|GPIO_PIN_4|Green_LED_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : PA1 PA4 Green_LED_Pin */
  GPIO_InitStruct.Pin = GPIO_PIN_1|GPIO_PIN_4|Green_LED_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
